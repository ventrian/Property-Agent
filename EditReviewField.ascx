<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EditReviewField.ascx.vb" Inherits="Ventrian.PropertyAgent.EditReviewField" %>
...
<dnn:sectionhead id="dshReviewFieldDetails" cssclass="Head" runat="server" text="Review Field Details" section="tblReviewFieldDetails"
	resourcekey="ReviewFieldDetails" includerule="True"></dnn:sectionhead>
<TABLE id="tblReviewFieldDetails" cellSpacing="0" cellPadding="2" width="100%" summary="Review Field Details Design Table"
	border="0" runat="server">
	<TR>
		<TD colSpan="3">
			<asp:label id="lblReviewFieldDetailsHelp" cssclass="Normal" runat="server" resourcekey="ReviewFieldDetailsDescription"
