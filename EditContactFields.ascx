<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EditContactFields.ascx.vb" Inherits="Ventrian.PropertyAgent.EditContactFields" %>
...
<asp:datagrid id="grdContactFields" Border="0" CellPadding="4" width="100%" AutoGenerateColumns="false"
	runat="server" summary="Contact Fields Table" BorderStyle="None" BorderWidth="0px"
	GridLines="None">
	<Columns>
		<asp:TemplateColumn ItemStyle-Width="20">
			<ItemTemplate>
				<asp:HyperLink NavigateUrl='<%# GetContactFieldEditUrl(DataBinder.Eval(Container.DataItem,"ContactFieldID").ToString()) %>' runat="server" ID="Hyperlink1">
...
<div align="center"><asp:Label ID="lblNoContactFields" Runat="server" CssClass="Normal" ResourceKey="NoContactFields" EnableViewState="False" Visible="False" /></div>
<dnnsc:PagingControl id="ctlPagingControl" runat="server"></dnnsc:PagingControl>
<p align="center">
	<asp:linkbutton id="cmdAddContactField" resourcekey="AddContactField" runat="server" cssclass="CommandButton" text="Add Contact Field" causesvalidation="False" borderstyle="none" />
	&nbsp;
