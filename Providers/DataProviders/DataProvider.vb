...
#Region " Property Methods "
        ...
        Public MustOverride Function AddProperty(ByVal moduleID As Integer, ByVal propertyTypeID As Integer, ByVal isFeatured As Boolean, ByVal dateCreated As DateTime, ByVal dateModified As DateTime, ByVal datePublished As DateTime, ByVal dateExpired As DateTime, ByVal viewCount As Integer, ByVal status As Integer, ByVal authorID As Integer, ByVal modifiedID As Integer, ByVal latitude As Double, ByVal longitude As Double) As Integer
        Public MustOverride Sub UpdateProperty(ByVal propertyID As Integer, ByVal moduleID As Integer, ByVal propertyTypeID As Integer, ByVal isFeatured As Boolean, ByVal dateCreated As DateTime, ByVal dateModified As DateTime, ByVal datePublished As DateTime, ByVal dateExpired As DateTime, ByVal viewCount As Integer, ByVal status As Integer, ByVal authorID As Integer, ByVal modifiedID As Integer, ByVal latitude As Double, ByVal longitude As Double)
