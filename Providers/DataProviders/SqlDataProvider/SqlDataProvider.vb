...
#Region " Property Methods "
        ...
        Public Overrides Function ListProperty(ByVal moduleID As Integer, ByVal propertyTypeID As Integer, ByVal status As Integer, ByVal authorID As Integer, ByVal brokerID As Integer, ByVal isActive As Boolean, ByVal isPending As Boolean, ByVal isExpired As Boolean, ByVal showFeaturedOnly As Boolean, ByVal sortBy As Integer, ByVal sortByID As Integer, ByVal sortByIDType As Integer, ByVal sortOrder As Integer, ByVal sortBy2 As Integer, ByVal sortByID2 As Integer, ByVal sortByIDType2 As Integer, ByVal sortOrder2 As Integer, ByVal sortBy3 As Integer, ByVal sortByID3 As Integer, ByVal sortByIDType3 As Integer, ByVal sortOrder3 As Integer, ByVal customFieldIDs As String, ByVal searchValues As String, ByVal pageNumber As Integer, ByVal pageSize As Integer, ByVal bubbleFeatured As Boolean, ByVal searchSubTypes As Boolean, ByVal propertyIDForNextPrev As Integer, ByVal latitude As Double, ByVal longitude As Double, ByVal startDate As DateTime, ByVal agentFilter As String, ByVal shortListID As String) As IDataReader
            Return CType(SqlHelper.ExecuteReader(ConnectionString, DatabaseOwner & ObjectQualifier & "Ventrian_PropertyAgent_PropertyList", moduleID, GetNull(propertyTypeID), GetNull(status), GetNull(authorID), GetNull(brokerID), GetNull(isActive), GetNull(isPending), GetNull(isExpired), GetNull(showFeaturedOnly), sortBy, GetNull(sortByID), GetNull(sortByIDType), sortOrder, GetNull(sortBy2), GetNull(sortByID2), GetNull(sortByIDType2), sortOrder2, GetNull(sortBy3), GetNull(sortByID3), GetNull(sortByIDType3), sortOrder3, GetNull(customFieldIDs), GetNull(searchValues), pageNumber, pageSize, bubbleFeatured, searchSubTypes, GetNull(propertyIDForNextPrev), GetNull(latitude), GetNull(longitude), GetNull(startDate), GetNull(agentFilter), GetNull(shortListID)), IDataReader)
        End Function

        Public Overrides Function AddProperty(ByVal moduleID As Integer, ByVal propertyTypeID As Integer, ByVal isFeatured As Boolean, ByVal dateCreated As DateTime, ByVal dateModified As DateTime, ByVal datePublished As DateTime, ByVal dateExpired As DateTime, ByVal viewCount As Integer, ByVal status As Integer, ByVal authorID As Integer, ByVal modifiedID As Integer, ByVal latitude As Double, ByVal longitude As Double) As Integer
            Return CType(SqlHelper.ExecuteScalar(ConnectionString, DatabaseOwner & ObjectQualifier & "Ventrian_PropertyAgent_PropertyAdd", moduleID, propertyTypeID, isFeatured, dateCreated, dateModified, GetNull(datePublished), GetNull(dateExpired), viewCount, status, authorID, modifiedID, GetNull(latitude), GetNull(longitude)), Integer)
        End Function

        Public Overrides Sub UpdateProperty(ByVal propertyID As Integer, ByVal moduleID As Integer, ByVal propertyTypeID As Integer, ByVal isFeatured As Boolean, ByVal dateCreated As DateTime, ByVal dateModified As DateTime, ByVal datePublished As DateTime, ByVal dateExpired As DateTime, ByVal viewCount As Integer, ByVal status As Integer, ByVal authorID As Integer, ByVal modifiedID As Integer, ByVal latitude As Double, ByVal longitude As Double)
            SqlHelper.ExecuteNonQuery(ConnectionString, DatabaseOwner & ObjectQualifier & "Ventrian_PropertyAgent_PropertyUpdate", propertyID, moduleID, propertyTypeID, isFeatured, dateCreated, dateModified, GetNull(datePublished), GetNull(dateExpired), viewCount, status, authorID, modifiedID, GetNull(latitude), GetNull(longitude))
        End Sub
