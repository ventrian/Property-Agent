<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="EditContactField.ascx.vb" Inherits="Ventrian.PropertyAgent.EditContactField" %>
...
<dnn:sectionhead id="dshContactFieldDetails" cssclass="Head" runat="server" text="Contact Field Details" section="tblContactFieldDetails"
	resourcekey="ContactFieldDetails" includerule="True"></dnn:sectionhead>
<TABLE id="tblContactFieldDetails" cellSpacing="0" cellPadding="2" width="100%" summary="Contact Field Details Design Table"
	border="0" runat="server">
	<TR>
		<TD colSpan="3">
			<asp:label id="lblContactFieldDetailsHelp" cssclass="Normal" runat="server" resourcekey="ContactFieldDetailsDescription"
	...
	<TR runat="server" id="trCustomField">
		<TD width="25"><IMG height=1 src='<%= Page.ResolveUrl("~/Images/Spacer.gif") %>' width=25></TD>
		<TD class="SubHead" noWrap width="150"><dnn:label id="plCustomField" runat="server" resourcekey="plCustomField" suffix=":" controlname="drpCustomField"></dnn:label></TD>
		<TD align="left" width="100%">
			<asp:dropdownlist id="drpCustomField" cssclass="NormalTextBox" runat="server" width="325" AutoPostBack="true"></asp:dropdownlist>
		</TD>
	</TR>
	<TR runat="server" id="trFieldElements">
		<TD width="25"><IMG height=1 src='<%= Page.ResolveUrl("~/Images/Spacer.gif") %>' width=25></TD>
		...
		<TD align="left" width="100%">
		    ...
		    <asp:requiredfieldvalidator id="valFieldElements" cssclass="NormalRed" runat="server" resourcekey="valFieldElements" controltovalidate="txtFieldElements"
			    errormessage="<br>You Must Enter a Valid Field Element" display="Dynamic" />
    ...
    <tr id="trMaximumLength" runat="Server">
	    ...
	    <td valign="bottom">
		    <asp:TextBox ID="txtMaximumLength" Runat="server" CssClass="NormalTextBox" width="325"
